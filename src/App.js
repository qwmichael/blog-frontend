...
var mySounds = [ '空虚な答え.mp3', 'Wings of Courage -空を超えて- instrumental ver.mp3', "アペイリア (Instrumental).mp3","松本文紀 - 邂逅.flac","彩菜 - freak of nature ： start.mp3","誰が為に.mp3","Histoire de Destin_ (Furuiro Meikyuu Rondo _Histoire de Destin_).mp3","松本文紀 - 夜の向日葵.flac","Narsissu Inst.mp3","阿保剛 - Karma -Klavier-.mp3"];
  ...
  return (
    <Router>     
       <Navbar bg="dark" variant="dark">
            ...
            <Button variant="light" className="right-buffer">&lt;</Button>
            <Button variant="light" className="right-buffer">></Button>            
            <audio controls src={chooseSong()}>
            </audio>
      </Navbar>
      <div id='page-body'>   
        <div className="App">
